...
import TwitterCredentialsC as twit
...
if __name__ == '__main__':
    # Setting up logging
    LOG_FILENAME = '/home/ubuntu/harvester/log/canberra_logger.log'
    logging.basicConfig(filename=LOG_FILENAME, level=logging.DEBUG, format='%(asctime)s %(message)s')

    CITY_GRID_FILENAME = '/home/ubuntu/harvester/Aurin_JSON/canberra.json'
    dictionaries = load_grid(CITY_GRID_FILENAME)

    canberra_area_box = [148.7828,-35.9149,149.4063,-35.1213]
    dbname = 'canberra'

    twitter_streamer = TwitterStreamer()
    twitter_streamer.stream_tweets(dictionaries, canberra_area_box)
