...
import TwitterCredentialsS as twit
...
if __name__ == '__main__':
    # Setting up logging
    LOG_FILENAME = '/home/ubuntu/harvester/log/sydney_logger.log'
    logging.basicConfig(filename=LOG_FILENAME, level=logging.DEBUG, format='%(asctime)s %(message)s')

    CITY_GRID_FILENAME = '/home/ubuntu/harvester/Aurin_JSON/sydney.json'
    dictionaries = load_grid(CITY_GRID_FILENAME)

    sydney_area_box = [150.2431,-34.4403,151.5079,-33.3347]
    dbname = 'sydney'

    twitter_streamer = TwitterStreamer()
    twitter_streamer.stream_tweets(dictionaries, sydney_area_box)
