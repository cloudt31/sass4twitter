...
import TwitterCredentialsM as twit
...
if __name__ == '__main__':
    # Setting up logging
    LOG_FILENAME = '/home/ubuntu/harvester/log/melbourne_logger.log'
    logging.basicConfig(filename=LOG_FILENAME, level=logging.DEBUG, format='%(asctime)s %(message)s')

    CITY_GRID_FILENAME = '/home/ubuntu/harvester/Aurin_JSON/melbourne.json'
    dictionaries = load_grid(CITY_GRID_FILENAME)

    melbourne_area_box = [144.5937,-38.5047,145.6299,-37.5113]
    dbname = 'melbourne'

    twitter_streamer = TwitterStreamer()
    twitter_streamer.stream_tweets(dictionaries, melbourne_area_box)
