...
import TwitterCredentialsP as twit
...
if __name__ == '__main__':
    # Setting up logging
    LOG_FILENAME = '/home/ubuntu/harvester/log/perth_logger.log'
    logging.basicConfig(filename=LOG_FILENAME, level=logging.DEBUG, format='%(asctime)s %(message)s')

    CITY_GRID_FILENAME = '/home/ubuntu/harvester/Aurin_JSON/perth.json'
    dictionaries = load_grid(CITY_GRID_FILENAME)

    perth_area_box = [115.5550415094,-32.7885221785,116.0567258875,-31.4781991154]
    dbname = 'perth'

    twitter_streamer = TwitterStreamer()
    twitter_streamer.stream_tweets(dictionaries, perth_area_box)
