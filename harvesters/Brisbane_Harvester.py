...
import TwitterCredentialsB as twit
...
if __name__ == '__main__':
    # Setting up logging
    LOG_FILENAME = '/home/ubuntu/harvester/log/brisbane_logger.log'
    logging.basicConfig(filename=LOG_FILENAME, level=logging.DEBUG, format='%(asctime)s %(message)s')

    CITY_GRID_FILENAME = '/home/ubuntu/harvester/Aurin_JSON/brisbane.json'
    dictionaries = load_grid(CITY_GRID_FILENAME)

    brisbane_area_box = [152.6685,-27.7674,153.5398,-26.9968]
    dbname = 'brisbane'

    twitter_streamer = TwitterStreamer()
    twitter_streamer.stream_tweets(dictionaries, brisbane_area_box)
